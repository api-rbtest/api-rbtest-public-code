...
# constraint_correctness	expected_test_outcome	correctness_of_script	correctness_of_revised_script


def categorize_constraint(excel_file, knowledge_base_file):
    # knowledge_base is a dataframe with columns: description, "category of constraint"
...
if __name__ == "__main__":
    root_exp = "approaches/api_rbtest"
    # root_exp = "FINAL_FINAL_EXP"
    # root_exp = "NAIVE_EXP"

    knowledge_base_file = "FINAL_FINAL_EXP/all_description.xlsx"
    ...
    for api in apis:
        ...
        response_excel = None
        request_excel = None 
        unique_response_excel = None
        unique_request_excel = None
        ...
        print(f"Found files: {response_excel}, {request_excel}, {unique_response_excel}, {unique_request_excel}")
