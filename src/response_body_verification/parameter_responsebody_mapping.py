...
def filter_attributes_in_schema_by_date_type(schema_spec, filterring_data_type):
...
class ParameterResponseMapper:
    def __init__(self, openapi_path, except_attributes_found_constraints_inside_response_body=False, 
                 ...
                 outfile=None, experiment_folder="experiment_1", is_naive=False):
                    ...
                    try:
                        ...
                        for param in specification:
                            ...
                            filterring_data_type = get_data_type(
                                specification[param])
                            filterred_attr_schema = filter_attributes_in_schema_by_date_type(
                            ...
                            if corresponding_attribute not in self.simplified_schemas[schema]:
                                self.found_mappings.append(mapping)
                                continue
