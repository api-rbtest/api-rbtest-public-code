...
def get_schema_recursive(body, spec, visited_refs=None):
    ...
    for ref in schema_refs:        
        ...
        if ref not in visited_refs:  # Check if schema_name is already processed
            ...
            new_schema = get_schema_params(schema_body, spec, get_description=True, max_depth=0, ignore_attr_with_schema_ref=True)  # Assuming get_schema_params is a function that processes the schema
